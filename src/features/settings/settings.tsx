...
import GearIcon from "../../components/icons/general/gear";
import ResetArrowsIcon from "../../components/icons/settings/resetArrows";
import { motion } from "framer-motion";
import SquareGradient from "./squareGradient";
import PerformanceButton from "./performanceButton";
import RocketIcon from "../../components/icons/settings/rocket";
import SatelliteIcon from "../../components/icons/settings/satellite";
import TelescopeIcon from "../../components/icons/settings/telescope";
